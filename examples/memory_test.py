...
def get_memory_manually(N,l):
    ...
    sigmax = get_annihilation_operator(HILBERT_SIZE) + get_creation_operator(HILBERT_SIZE)
    # E.q. 19 (p. 6) of https://arxiv.org/abs/1904.06560.
    H_SYSTEM_0 = get_creation_operator(HILBERT_SIZE) * get_annihilation_operator(HILBERT_SIZE)
