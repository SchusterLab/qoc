...
def simulation(q_number,max_con,initial,mode):
    ...
    Initial_state=Initial_state.reshape((2**q_number,2**q_number))
    Target=Target.reshape((2**q_number,2**q_number))
    ...
    if mode == "AD":
        ...
        manual_parameter = {"control_hamiltonian": H_control, "manual_gradient_mode": True, "tol": 1e-3}
